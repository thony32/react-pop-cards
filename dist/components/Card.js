...
} /* eslint-disable react-hooks/exhaustive-deps */ /* eslint-disable react-hooks/rules-of-hooks */
const Card = (_ref) => {
    let { data, bgColor, disposition, isRounded, tension, friction } = _ref
                ...
                return /*#__PURE__*/ _react.default.createElement(
                    "div",
                    {
                        ...
                        className: "bg-base-100 "
                            .concat(activeCard === value.title ? "scale-105 shadow-xl" : "scale-90", " ")
                            .concat(miniCardClass, " ")
                            .concat(isRounded ? "rounded-2xl" : "rounded-none"),
                    },
                    /*#__PURE__*/ _react.default.createElement(
                        "label",
                        {
