    ...
    return (
        <div className="space-y-[3%] px-[8%] py-[2%] relative h-screen">
            <div className="space-y-3">
                <h1 className="text-7xl font-fortnite" style={{ color: bgColor }}>React pop cards</h1>
                ...
                <div className="flex gap-3 items-center justify-start">
                    <a className="hover:scale-110 duration-150 tooltip tooltip-right" data-tip="Project link" href="https://github.com/thony32/react-pop-cards" target="_blank" rel="noreferrer">
                        <svg className="w-7" viewBox="0 0 20 20">
                            <g style={{ fill: bgColor }} className="fill-current duration-100" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    ...
                    <a className="hover:scale-110 duration-150" href="https://www.linkedin.com/in/anthony-mahefasoa-3672361b2/" target="_blank" rel="noreferrer">
                        <svg style={{ fill: bgColor }} className="w-8 fill-current duration-100" viewBox="-143 145 512 512">
                            <path d="M113,145c-141.4,0-256,114.6-256,256s114.6,256,256,256s256-114.6,256-256S254.4,145,113,145z M41.4,508.1H-8.5V348.4h49.9 V508.1z M15.1,328.4h-0.4c-18.1,0-29.8-12.2-29.8-27.7c0-15.8,12.1-27.7,30.5-27.7c18.4,0,29.7,11.9,30.1,27.7 C45.6,316.1,33.9,328.4,15.1,328.4z M241,508.1h-56.6v-82.6c0-21.6-8.8-36.4-28.3-36.4c-14.9,0-23.2,10-27,19.6 c-1.4,3.4-1.2,8.2-1.2,13.1v86.3H71.8c0,0,0.7-146.4,0-159.7h56.1v25.1c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z" />
                        </svg>
                    </a>
                </div>
                <div style={{ color : bgColor }} className="flex items-center justify-center font-fortnite duration-100">Decepticon , copyright {new Date().getFullYear()}</div>
                <div className="flex items-center justify-end gap-3">
                    <svg style={{ fill: bgColor }} className="w-7 fill-current duration-100" viewBox="0 0 16 16" fill="none">
                        <path
                            fillRule="nonzero"
                            clipRule="nonzero"
                    ...
                    <svg style={{ fill: bgColor }} className="w-7 fill-current duration-100" viewBox="0 0 15 15" fill="none">
